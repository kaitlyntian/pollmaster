...
const UserRegistrationPage = ({ hasUser, setLogin }) => {
  ...
  return (
    <div className="UserRegistrationPage main-container">
      <h1 className="visually-hidden">User Registration Page</h1>
      <Row className="mainRow">
        <Col>
          <div id="regPurpose" className="main-child">
            <h2>Poll Master</h2>
        ...
        <Col>
          <div className="regis-form-field main-child">
            <h2>Registration</h2>
              ...
              <Form.Group className="mb-3" controlId="registrationPassword">
                ...
                <InputGroup hasValidation>
                  ...
                  {passwordErrorMessage ? (
                    ...
                    <Form.Text>
                      Password should be at least 6 character long contain at least one lowercase character, one
